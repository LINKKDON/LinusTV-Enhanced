  ...
  return (
    <PageLayout>
      ...
      <div className='overflow-visible -mt-6 md:mt-0 pb-32 md:pb-safe-bottom'>
        {/* 欢迎横幅 - 现代化精简设计 */}
        <div className='hidden mb-6 relative overflow-hidden rounded-xl bg-linear-to-r from-blue-500/90 via-purple-500/90 to-pink-500/90 backdrop-blur-sm shadow-xl border border-white/20'>
